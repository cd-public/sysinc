...
- Your responsibility
  ...
  - You will store your "shainc.c" file in the "shainc" folder on your "sysinc" GitHub repository.
...
- Also available on [GitHub](https://github.com/cd-c89/sysinc/blob/main/shainc/shainc.c)
...
RUN curl https://raw.githubusercontent.com/cd-c89/sysinc/refs/heads/main/shainc/tester.sh -o tester.sh

COPY shainc.c .
```

- It may be easier to review the test script here than on [GitHub](https://github.com/cd-c89/sysinc/blob/main/shainc/tester.sh):
