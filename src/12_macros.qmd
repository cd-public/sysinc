...
- Your responsibility
  ...
  - You will create a private GitHub repository named "sysinc"
    - I recommend creating a new repository of your own, not forking a repository.
    - You can fork this one, if you need to.
  ...
  - If you would like to fork an existing repository, use this one:
    - [https://github.com/cd-c89/sysinc](https://github.com/cd-c89/sysinc)
...
RUN curl https://raw.githubusercontent.com/cd-c89/sysinc/refs/heads/main/macros/tester.c -o tester.c

RUN curl https://raw.githubusercontent.com/cd-c89/sysinc/refs/heads/main/macros/tester.sh -o tester.sh
