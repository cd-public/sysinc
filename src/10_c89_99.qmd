...
- The first homework, "Enigma", is ready after this class.
  - Due Thursday, 03 Sep at midnight AOE
...
- Change the link as well.
  - [http://127.0.0.0:8083/](http://127.0.0.0:8083/)
...
1548a1d7dce5  docker.io/library/httpd:latest  httpd-foreground  4 minutes ago  Up 4 minutes ago  0.0.0.0:8080->80/tcp  busy_wiles
0a47ae6c6039  docker.io/library/httpd:latest  httpd-foreground  2 seconds ago  Up 3 seconds ago  0.0.0.0:8083->80/tcp  naughty_rama
```
...
- I have been told to tell you to try `vimtutor`
...
```bash
user@DESKTOP-THMS2PJ:~/sysinc/c89_99$ podman exec -it -l gcc samp.c --std=c89
...
user@DESKTOP-THMS2PJ:~/sysinc/c89_99$ podman exec -it -l gcc samp.c
```
...
- Learn modern C/C++/C# via Stack Overflow
...
- I recommend:
  - Pop in browser
  - Make a private github repo, like "sysinc"
...
- In the meantime, I'd just keep a Containerfile at top level in your "sysinc" repo.
