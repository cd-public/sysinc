...
- This is the second of two "data structures" assignments, implementing the "Merkle tree" of blockchain.
...
- It is split over 3 files:
  ...
  - `heap_t.h` which the public API you will implement, as with `list_t`
    ...
    - This is the learning objective of the assignment.
