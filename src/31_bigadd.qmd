...
- I was unable to achieve a bugfree multiply absent this interface, but was able to progress rapidly once I developed it.
  - [tester.py](https://github.com/cd-c89/sysinc/blob/main/4096_t/tester.py)
  - [tester.c](https://github.com/cd-c89/sysinc/blob/main/4096_t/tester.c)
