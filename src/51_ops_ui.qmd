...
- You will note it includes LibGMP.
  ...
  - LibGMP will help us latter but we need to learn what it is doing first.
    - It will be helpful in testing.
...
```{.email}
$ pwd
/home/user/dev/sysinc/ops_ui
$ cd ..
$ pwd
/home/user/dev/sysinc
$ cd 4096_t
$ pwd         
/home/user/dev/sysinc/4096_t
$ head -1 4096_t.h
/* 4096_t.h */
```
...
- Separately, I have provided `biggmp.c`
    ...
    - It is a "drop in replacement"
        ...
        - Replace it with `biggmp.c`
            - [biggmp.c](https://github.com/cd-c89/sysinc/blob/main/ops_ui/biggmp.c)
...
- I was unable to achieve a bugfree multiply absent this interface, but was able to progress rapidly once I developed it.
  - [tester.py](https://github.com/cd-c89/sysinc/blob/main/ops_ui/tester.py)
  - [tester.c](https://github.com/cd-c89/sysinc/blob/main/ops_ui/tester.c)
