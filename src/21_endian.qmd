...
l += fread(bytes, 1, 64, fp); /* Think about what type of thing "l" is counting */
```
...
- I note I will assume the "host" is little endian.
...
- This will cause a segmentation fault for the following reason.
  ...
  - When `new_hash` returns, it no longer manages its local variables.
