...
- GitHub Pages is a little bit *automated*
    - Read: I've taught it to middle/high school summer camps.
...
```{.email}
22.04, jammy-20260901.2, jammy
24.04, noble-20260905, noble
26.04, resolute-20260901, resolute, latest, rolling
26.10, stonking-20260901.1, stonking, devel
```
...
- "make" commands tend to be 5 char, next most common I see is "check"
...
- Add "GitHub Actions and CI/CD pipelines for DevOps" to your resume.